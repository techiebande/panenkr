...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-3 rounded-xl border-2 border-input bg-background/50 px-4 py-3 text-base",
        "data-[placeholder]:text-muted-foreground/60 data-[placeholder]:font-light",
        ...
        "data-[size=default]:h-12 data-[size=sm]:h-10 data-[size=sm]:px-3 data-[size=sm]:text-sm",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "overflow-x-hidden overflow-y-auto rounded-xl border-2 border-border/40 shadow-xl",
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "hover:bg-muted/50 focus:bg-muted focus:text-foreground",
